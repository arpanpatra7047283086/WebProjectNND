  ...
  return (
    <footer className="bg-white border-t border-border">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Newsletter Section */}
        <motion.div
          className="bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/20 rounded-2xl p-8 md:p-12 mb-16"
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold rounded-lg hover:shadow-lg transition-all"
              >
